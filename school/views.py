...
#for showing signup/login button for teacher(by Pandya)
...
#for showing signup/login button for student(by Pandya)
...
#for checking user is techer , student or admin(by Pandya)
def is_admin(user):
...
#for dashboard of adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Pandya)
...
def admin_dashboard_view(request):
    ...
    #aggregate function return dictionary so fetch data from dictionay(by Pandya)
    mydict={
...
#for teacher sectionnnnnnnn by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Pandya)
...
#for student by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Pandya)
...
#attendance related viewwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(by Pandya)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#fee related view by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Pandya)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#notice related viewsssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss(by Pandya)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#for TEACHER  LOGIN    SECTIONNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN(by Pandya)
...
#FOR STUDENT AFTER THEIR Loginnnnnnnnnnnnnnnnnnnnn(by Pandya)
...
# for aboutus and contact ussssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss (by Pandya)
